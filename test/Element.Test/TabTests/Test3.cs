...
namespace IssueManage.Test.TabTests
{
    ...
    public class Test3 : IDemoTester
    {
        ...
        {
            var header = await card.Body.QuerySelectorAsync("div.el-tabs.el-tabs--border-card.el-tabs--top > div.el-tabs__header.is-top");
            var body = await card.Body.QuerySelectorAsync("div.el-tabs.el-tabs--border-card.el-tabs--top > div.el-tabs__content");
